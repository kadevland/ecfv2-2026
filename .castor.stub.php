...
namespace Castor\Attribute {
    ...
    final class AsArgsAfterOptionEnd extends \Castor\Attribute\AsRawTokens
    {
    }
    #[\Attribute(\Attribute::TARGET_PARAMETER)]
    ...
    class AsPathArgument extends \Castor\Attribute\AsArgument
    {
         ...
         */
        public function __construct(?string $name = null, string $description = '', public readonly ?string $directory = null, public readonly string|array|null $filter = null)
        {
        }
    }
    #[\Attribute(\Attribute::TARGET_PARAMETER)]
    class AsPathOption extends \Castor\Attribute\AsOption
    {
         ...
         * @param string|array<string>|null $filter
         */
        public function __construct(?string $name = null, string|array|null $shortcut = null, ?int $mode = null, string $description = '', public readonly ?string $directory = null, public readonly string|array|null $filter = null)
        {
        }
    }
    #[\Attribute(\Attribute::TARGET_PARAMETER)]
...
namespace Castor\Console\Command {
    ...
    class TaskCommand extends \Symfony\Component\Console\Command\Command implements \Symfony\Component\Console\Command\SignalableCommandInterface
    {
        ...
        public function __construct(private readonly \Castor\Descriptor\TaskDescriptor $taskDescriptor, private readonly \Castor\ExpressionLanguage $expressionLanguage, private readonly \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher, private readonly \Castor\ContextRegistry $contextRegistry, private readonly \Castor\Helper\Slugger $slugger, private readonly \Symfony\Component\Filesystem\Filesystem $fs, \Symfony\Component\ErrorHandler\ErrorRenderer\FileLinkFormatter $fileLinkFormatter)
        {
        }
        /**
         * @return array<int>
...
namespace Castor {
    ...
    function terminal(): \Symfony\Component\Console\Terminal
    {
    }
}
...
namespace Castor\Factory {
    ...
    {
        public function __construct(private readonly \Castor\ExpressionLanguage $expressionLanguage, private readonly \Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher, private readonly \Castor\ContextRegistry $contextRegistry, private readonly \Castor\Helper\Slugger $slugger, private readonly \Symfony\Component\Filesystem\Filesystem $fs, private readonly \Symfony\Component\ErrorHandler\ErrorRenderer\FileLinkFormatter $fileLinkFormatter)
        {
        }
...
namespace Symfony\Component\Console {
    ...
    */
    ...
    {
        public function __construct(private string $name = 'UNKNOWN', private string $version = 'UNKNOWN', private ?\Psr\Container\ContainerInterface $container = null)
        {
        }
        /**
         * @final
         ...
         * @final
         */
        public function setArgumentResolver(\Symfony\Component\Console\ArgumentResolver\ArgumentResolverInterface $argumentResolver): void
        {
        }
        public function getArgumentResolver(): ?\Symfony\Component\Console\ArgumentResolver\ArgumentResolverInterface
        {
        }
        ...
        *
        * @param callable[]|\Symfony\Component\Console\Command\Command[] $commands An array of commands
        */
        public function addCommands(array $commands): void
        {
        }
        public function addCommand(callable|\Symfony\Component\Console\Command\Command $command): ?\Symfony\Component\Console\Command\Command
        {
        }
        /**
    ...
    class Terminal
    {
        public const DEFAULT_COLOR_MODE = \Symfony\Component\Console\Output\AnsiColorMode::Ansi4;
        public static function getColorMode(): \Symfony\Component\Console\Output\AnsiColorMode
        {
        }
        public static function setColorMode(?\Symfony\Component\Console\Output\AnsiColorMode $colorMode): void
        {
        }
...
namespace Symfony\Component\Console\Input {
    ...
    class InputOption
    {
         ...
         * @throws \Symfony\Component\Console\Exception\InvalidArgumentException If option mode is invalid or incompatible
         */
        public function __construct(string $name, string|array|null $shortcut = null, ?int $mode = null, private string $description = '', mixed $default = null, private array|\Closure $suggestedValues = [])
        {
        }
...
namespace Symfony\Component\Console\Style {
    ...
    class SymfonyStyle extends \Symfony\Component\Console\Style\OutputStyle
    {
        ...
        public function __construct(private \Symfony\Component\Console\Input\InputInterface $input, private \Symfony\Component\Console\Output\OutputInterface $output, private ?\Symfony\Contracts\EventDispatcher\EventDispatcherInterface $dispatcher = null)
        {
        }
        ...
        public function askFile(string $question): ?\Symfony\Component\Console\Input\File\InputFile
        {
        }
        /**
...
namespace Symfony\Component\Finder {
    ...
    * @author Fabien Potencier <fabien@symfony.com>
    *
    * @implements \IteratorAggregate<non-empty-string, \Symfony\Component\Finder\SplFileInfo>
    */
    class Finder implements \IteratorAggregate, \Countable
    {
        ...
        *
        * @return \Iterator<non-empty-string, \Symfony\Component\Finder\SplFileInfo>
        *
        ...
        *
        * @param iterable<\Symfony\Component\Finder\SplFileInfo|\SplFileInfo|string> $iterator
        *
        * @return $this
        */
...
namespace Symfony\Component\Process {
    ...
    */
    class Process implements \IteratorAggregate
    {
        ...
        * @return $this
        *
        * @throws \Symfony\Component\Process\Exception\ProcessFailedException When process didn't terminate successfully
...
namespace Symfony\Contracts\HttpClient {
    ...
    {
        public const OPTIONS_DEFAULTS = ['auth_basic' => null, 'auth_bearer' => null, 'query' => [], 'headers' => [], 'body' => '', 'json' => null, 'user_data' => null, 'max_redirects' => 20, 'http_version' => null, 'base_uri' => null, 'buffer' => true, 'on_progress' => null, 'resolve' => [], 'proxy' => null, 'no_proxy' => null, 'timeout' => null, 'max_duration' => 0, 'max_connect_duration' => 0, 'bindto' => '0', 'verify_peer' => true, 'verify_host' => true, 'cafile' => null, 'capath' => null, 'local_cert' => null, 'local_pk' => null, 'passphrase' => null, 'ciphers' => null, 'peer_fingerprint' => null, 'capture_peer_cert_chain' => false, 'crypto_method' => \STREAM_CRYPTO_METHOD_TLSv1_2_CLIENT, 'extra' => ['use_persistent_connections' => false]];
        /**
